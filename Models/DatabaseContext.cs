...
namespace demo1.Models
{
    public class DatabaseContext<T> where T : class, new()
    {
        ...
        public static string ConnectString = "FitnessConnectionString";
        ...
        public DatabaseContext(string connectString = "FitnessConnectionString")
        {
        ...
        public T GetFirstByFieldOrDefault(string field, object value, int type, string orderBy = null)
        {
            try
            {
                Instance = GetInStance();
